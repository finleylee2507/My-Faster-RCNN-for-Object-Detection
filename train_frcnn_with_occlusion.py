...
parser.add_option("--occlusion_percentage", dest="occlusion_percentage", help="What percentage of positive rois should be occluded",type=float, default=0.5)
            ...
            if(bool(options.isOcclude)):
                ...
                for i in range(0, C.num_rois):  # iterate over all the ROIs
                    ...
                    # apply occlusion on the pooling layer output according to the selected policy
                        if (random.uniform(0,1)<options.occlusion_percentage): #apply occlusion randomly according to the ratio given 
                            ...
                            if(options.thresholding == 'sampling'):  # apply sampling thresholding
                                ...
                                processed_output = thresholding_helper.threshold_by_sampling(
                                    occlusion_mask[0, :, :, 0], 1/3, 2/5)  # could tweak the parameters
                                # reshape output
