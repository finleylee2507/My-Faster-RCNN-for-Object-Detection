...
try:
	...
	model_pooling.load_weights(C.base_net_weights, by_name=True) #might not be necessary 
...
if options.load is not None:  # with pretrained FRCNN model
	...
	model_pooling.load_weights(options.load, by_name=True) #might not be necessary 
