...
parser.add_option("--noise", "--noise", dest="noise", help="Augment with random noise in training. (Default=false).",
				  action="store_true", default=False)
parser.add_option("--blur", "--blur", dest="blur", help="Augment with gaussian blur in training. (Default=false).",
				  action="store_true", default=False)
parser.add_option("--brightness", "--brightness", dest="brightness", help="Augment with higher or lower brightness in training. (Default=false).",
				  action="store_true", default=False)
...
C.noise = bool(options.noise)
if(C.noise):
    C.list.append('noise')
print("Noise? ")
print(C.noise)

C.blur = bool(options.blur)
if(C.blur):
    C.list.append('blur')
print("Blur? ")
print(C.blur)
...
C.brightness = bool(options.brightness)
if(C.brightness):
...
print("The options selected:", C.list)
