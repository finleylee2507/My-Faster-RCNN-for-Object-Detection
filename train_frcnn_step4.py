#step 4 of the alternating training 
...
parser.add_option("--rp", "--record_path", dest="record_path",
                  help="Path to the record path.", default='./models/records/record_step4_copy.csv')
...
C.model_path = os.path.join("models", options.network, options.dataset+"_step4_"+".hdf5")
...
if options.rpn_weight_path is not None:  # with pretrained RPN
